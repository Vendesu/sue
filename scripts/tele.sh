...
if [ "$#" -ne 2 ]; then
  ...
  echo " win_2012R2_uefi, win_2016_uefi, win_2019_uefi, win_2022_uefi, win_10_uefi, win_11_uefi"
...
if [[ "$IMG_VERSION" =~ ^https?://.*\.gz.*$ ]]; then
  ...
  case $IMG_VERSION in
    ...
    # Lite Versions
    win_2022_lite)
      IMG_URL="https://files.meocloud.my.id/11:/winsrv2022lite.gz"
      ;;
    win_2016_lite)
      IMG_URL="https://files.meocloud.my.id/11:/winsrv2016lite.gz"
      ;;
    win_2012R2_lite)
      IMG_URL="https://files.meocloud.my.id/11:/winsrv2012r2lite.gz"
      ;;
    win_7_sp1_lite)
      IMG_URL="https://files.meocloud.my.id/11:/win7lite.gz"
      ;;
    # UEFI Versions
    win_2012R2_uefi)
    ...
    *)
      ...
      echo "win_2022_uefi, win_10_uefi, win_11_uefi"
